...
One of my favorite thinkers about digital learning is Seymour Papert - the inventor of the Logo programming environment which you may be familiar with. Here I've got a quote from his fantastic book Mindstorms - and I think he hits the nail on the head. When it comes to educational technology and perhaps reading content in particular we're very much applying old instructional methods, like the 1000 page pre-packaged print textbook, to new technologies like cloud-based delivery onto your mobile device. The sad thing is - Papert wrote this book in 1980, and we're largely using those same textbooks today.

So how do we change that? We see books busting out of their bindings, and a crucial need to support granular, mind-sized chunks of interactive content delivered through a panoply of new user experiences. We also see new capabilities landing in the open web platform every day – from new browser APIs that can power interesting new learning modalities, to broader support for rich media, to a growing number of student-centric tools and APIs available for integration. It’s time to recalibrate your mental image of a digital book, and think outside textbook.

What I have to show today is a suite of demos and experiments focused on two categories of exploration. On the one hand, I've got a number of examples of content that we've put together to try to stretch the limits of a book - exploiting the range of interesting interactive possibilities available in modern browsers for students. On the other hand, we’ve worked hard to make our technology modular and interchangeable, to take that great next generation content and make it plug and play into a wide variety of environments, use cases and business models. By tapping into both sides of that equation we can not only create a richer texture of ways to deliver engaging content, but we can deliver those powerful ideas in new and compelling ways.
